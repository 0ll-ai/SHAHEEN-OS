  ...
  describe('checkForUpdates', () => {
    ...
    it('should set stage to latest when missing manifest 404 (gap period)', async () => {
      const error = new Error(
        'Cannot find latest-mac.yml in the latest release artifacts (https://github.com/lobehub/shaheen-os/releases/download/v2.0.0-next.311/latest-mac.yml): HttpError: 404',
      );
