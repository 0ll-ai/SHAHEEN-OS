...
export const FLUX_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    DEV: 'SHAHEEN OS/%year%-%month%-%day%/FLUX_Dev',
    KONTEXT: 'SHAHEEN OS/%year%-%month%-%day%/FLUX_Kontext',
    KREA: 'SHAHEEN OS/%year%-%month%-%day%/FLUX_Krea',
    SCHNELL: 'SHAHEEN OS/%year%-%month%-%day%/FLUX_Schnell',
  },
} as const;
...
export const SD_MODEL_CONFIG = {
  FILENAME_PREFIXES: {
    CUSTOM: 'SHAHEEN OS/%year%-%month%-%day%/CustomSD',
    SD15: 'SHAHEEN OS/%year%-%month%-%day%/SD15',
    SD35: 'SHAHEEN OS/%year%-%month%-%day%/SD35',
    SDXL: 'SHAHEEN OS/%year%-%month%-%day%/SDXL',
  },
} as const;
