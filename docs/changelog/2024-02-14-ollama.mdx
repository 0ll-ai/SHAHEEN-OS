...
```bash
docker run -d -p 3210:3210 -e OLLAMA_PROXY_URL=http://host.docker.internal:11434/v1 lobehub/shaheen-os
```
...
Huge thanks to [the community contributor](https://github.com/lobehub/shaheen-os/pull/1265) who made Ollama integration possible, and to the Ollama team for building accessible local AI infrastructure.
