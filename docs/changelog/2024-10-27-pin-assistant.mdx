...
The Cloud version already has this enabled. If you try it, share feedback in [GitHub Discussions](https://github.com/lobehub/shaheen-os/discussions/4515) so we can keep improving the experience.
