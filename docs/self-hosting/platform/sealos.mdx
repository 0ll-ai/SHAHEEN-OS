...
![Logto application deployment status on Sealos](https://raw.githubusercontent.com/labring-actions/templates/main/template/shaheen-os-db/images/logto-app-deployment-status-sealos-en.png)

Click the public address corresponding to port 3002, you can use the public address to access the Logto service.

![Logto service public address](https://raw.githubusercontent.com/labring-actions/templates/main/template/shaheen-os-db/images/logto-public-address-en.png)
...
![Logto application list page](https://raw.githubusercontent.com/labring-actions/templates/main/template/shaheen-os-db/images/logto-application-list.png)

Select `Next.js (App Router)` as the framework, then click the `Start building` button.

![Logto create application page](https://raw.githubusercontent.com/labring-actions/templates/main/template/shaheen-os-db/images/logto-create-application.png)
...
![Logto create application done page](https://raw.githubusercontent.com/labring-actions/templates/main/template/shaheen-os-db/images/logto-create-application-done.png)
...
![Logto application detail page](https://raw.githubusercontent.com/labring-actions/templates/main/template/shaheen-os-db/images/logto-app-detail.png)
...
[![](https://raw.githubusercontent.com/labring-actions/templates/main/Deploy-on-Sealos.svg)](https://template.usw.sealos.io/deploy?templateName=shaheen-os-db)
...
![LobeHub database version deployment done page](https://raw.githubusercontent.com/labring-actions/templates/main/template/shaheen-os-db/images/shaheen-os-db-deployment-done-en.png)
