...
export const activateSkillApi: SHAHEEN OSPluginApi = {
  description:
...
export const readReferenceApi: SHAHEEN OSPluginApi = {
  description:
...
export const exportFileApi: SHAHEEN OSPluginApi = {
  description:
...
export const runCommandApi: SHAHEEN OSPluginApi = {
  description:
