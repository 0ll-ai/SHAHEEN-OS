...
export const GITHUB = 'https://github.com/lobehub/shaheen-os';
...
export const FEEDBACK = 'https://github.com/lobehub/shaheen-os/issues/new/choose';
...
export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/lobehub/shaheen-os/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/lobehub/shaheen-os/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/lobehub/shaheen-os-agents';
