          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'SHAHEEN OS is an AI conversation application built with the Next.js framework. I will help you write the development documentation for SHAHEEN OS.',
                tags: [
