          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'SHAHEENOS is an AI conversation application built with the Next.js framework. I will help you write the development documentation for SHAHEENOS.',
                tags: [
                ...
                title: 'SHAHEENOS Technical Documentation Expert',
              },
              type: 'agent',
