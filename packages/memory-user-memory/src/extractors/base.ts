        ...
        return tracer.startActiveSpan(
          `generate_content: ${this.model}`,
          {
            attributes: {
              ...
              'shaheen-os.memory.extractor.context': options?.retrievedContexts,
              'shaheen-os.memory.extractor.identities_context': options?.retrievedIdentitiesContext,
              'shaheen-os.memory.extractor.language': options?.language,
              'shaheen-os.memory.extractor.source_id': options?.sourceId,
              'shaheen-os.memory.extractor.top_k': options?.topK,
              'shaheen-os.memory.extractor.user_id': options?.userId,
            },
          },
          async (span) => {
            try {
