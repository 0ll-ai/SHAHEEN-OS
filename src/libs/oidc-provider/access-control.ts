 ...
 */
export const revokeOIDCArtifactsByUserId = async (db: SHAHEENOSDatabase, userId: string) => {
 ...
 */
export const assertOIDCUserActive = async (db: SHAHEENOSDatabase, userId: string) => {
  const [user] = await db
